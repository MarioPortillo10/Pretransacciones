    ...
    <body>
                                ...
                                <div class="code-box">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txt_licenciaa" CssClass="form-control" runat="server"
                                                Enabled="false" hidden></asp:TextBox>
                                        </div>
     ...
     <!-- Modal de Validación -->
                                        ...
                                        <div class="modal-body">
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                <ContentTemplate>
                                                    <form>
                                                        <div class="form-group">
                                                            <label for="txt_licencia">Ingenio</label>
                                                            <asp:TextBox ID="txt_licencia" CssClass="form-control" runat="server" Enabled="false"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txt_motorista">Producto</label>
                                                            <asp:TextBox ID="txt_motorista" CssClass="form-control" runat="server" Enabled="false"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group mb-2">
                                                            <label for="txt_placa">Placa Camion</label>
                                                            <asp:TextBox ID="txt_placa" CssClass="form-control" runat="server" Enabled="false"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group mb-2">
                                                            <label for="txt_placaremolque">Placa Remolque</label>
                                                            <asp:TextBox ID="txt_placaremolque" CssClass="form-control" runat="server" Enabled="false"></asp:TextBox>
                                                        </div>
                                                    </form>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
        ...
        <script>
            ...
            function checkInput() {
                ...
                if (txtTransaccion === '') {
                    ...
                    document.getElementById('hfTransaccion').value = txtTransaccion;
                    // Make AJAX call to fetch data
                    //return 0;
                    $('#editModal').modal('show');
                    $.ajax({
                        type: "POST",
                        url: "Basculas/Prechequeo.aspx/lnkBuscar_Click", // Ensure this URL is correct
                        data: JSON.stringify({}),
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (response) {
                            console.log("esto es data: ", response)
                            var data = response.d; // Assuming the returned data is in response.d
                            // Populate the modal fields
                            $('#txt_licencia').val(data.driver.license);
                            $('#txt_motorista').val(data.product);
                            $('#txt_placa').val(data.vehicle.plate);
                            $('#txt_placaremolque').val(data.vehicle.trailerPlate);
        ...
        .then(stream => {
            ...
            // Upload the photo to the server (optional)
            // ...
            });
        })
        .catch(error => {
