                ...
                <div class="card" style="height: 300px; border-radius: 15px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
                    ...
                    <div class="card-body d-flex flex-column align-items-center justify-content-center">
                        <div id="progressCircle1" style="width: 125px; height: 125px; border-radius: 50%; background: #f0f0f0; position: relative;">
                            <div id="timerText1" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 22px;">00:00:00</div>
                        </div>
    ...
    <div class="card" style="height: 300px; border-radius: 15px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
        ...
        <div class="card-body d-flex flex-column align-items-center justify-content-center">
            <div id="progressCircle2" style="width: 125px; height: 125px; border-radius: 50%; background: #f0f0f0; position: relative;">
                <div id="timerText2" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 22px;">00:00:00</div>
            </div>
            <div class="button-container mt-4">
                ...
                <div class="card" style="height: 250px;">
                    ...
                    <div class="card-body d-flex flex-column align-items-left justify-content-left">
                        <h6 class="card-text text-left">Transaccion:   2328932</h6>
                        <h6 class="card-text text-left">Fecha:         25/10/2024</h6>
                        <h6 class="card-text text-left">Motorista:     Alan Alberto Martinez</h6>
                        <h6 class="card-text text-left">Ingenio:       Ingenio Central Jiboa</h6>
                        <h6 class="card-text text-left">Placa Remolque: R1092</h6>
                        <h6 class="card-text text-left">Placa Camion:  C2323</h6>
                    </div>
                </div>
            </div>  
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
                <div class="card" style="height: 250px;">
                    ...
                    <div class="card-body d-flex flex-column align-items-left justify-content-left">
                       <h6 class="card-text text-left">Transaccion:   2328933</h6>
                        <h6 class="card-text text-left">Fecha:         25/10/2024</h6>
                        <h6 class="card-text text-left">Motorista:     Juan Carlos Diaz</h6>
                        <h6 class="card-text text-left">Ingenio:       Ingenio Central Jiboa</h6>
                        <h6 class="card-text text-left">Placa Remolque: R2092</h6>
                        <h6 class="card-text text-left">Placa Camion:  C2389</h6>
                    </div>
                </div>
            </div> 
        </div>
...
function createTimer(progressCircleId, timerTextId, startButtonId, stopButtonId, duration) {
    let progress = 0; // Progreso en milisegundos
    let interval;
    ...
    document.getElementById(startButtonId).addEventListener('click', function(event) {
        ...
        if (!isRunning) { // Solo inicia si no está corriendo
            ...
            interval = setInterval(() => {
                progress += 100; // Incrementa en 100 milisegundos
                const angle = (progress / (duration * 1000)) * 360; // Convertir duración a milisegundos
                document.getElementById(progressCircleId).style.background = `conic-gradient(${getColor(progress / 1000)} ${angle}deg, #f0f0f0 ${angle}deg)`;
                
                const minutes = String(Math.floor((progress / 1000) / 60)).padStart(2, '0');
                const seconds = String(Math.floor((progress / 1000) % 60)).padStart(2, '0');
                const milliseconds = String(Math.floor((progress % 1000) / 10)).padStart(2, '0'); // Convertir milisegundos a formato 000
                document.getElementById(timerTextId).innerText = `${minutes}:${seconds}:${milliseconds}`;
