...
public partial class Basculas_Prechequeo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        txt_licencia.Text = "Ingenio Ejemplo";
        txt_motorista.Text = "Producto Ejemplo";
        txt_placa.Text = "ABC-1234";
        txt_placaremolque.Text = "XYZ-5678";
    ...
    protected void lnkBuscar_Click(object sender, EventArgs e)
    {
        ...
        string url = "http://192.168.200.112:3000/api/shipping/" + transaccion;
        ...
        using (WebClient client = new WebClient())
        {
            ...
            try
            {
                ...
                txt_motorista.Text = data.product;
                txt_placa.Text = data.vehicle.plate;
                txt_placaremolque.Text = data.vehicle.trailerPlate;

                // Aquí se asegura que el modal se muestra al obtener los datos correctamente
                ScriptManager.RegisterStartupScript(this, this.GetType(), "abrirModal", "$('#editModal').modal('show');", true);
            }
