<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rutas_Actividades.aspx.cs" Inherits="Basculas_Rutas_Actividades" %>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link bg-primary text-white" href="Rutas_Actividades.aspx"><i class="fas fa-road"></i>&nbsp;Rutas Actividades</a>
                    </li>
                </ul>
            ...
            <asp:GridView ID="gvw_rutas_plantillas" CssClass="table table-hover table-striped" GridLines="None" runat="server" AutoGenerateColumns="false" DataKeyNames="Code">
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div>
                                <asp:LinkButton CssClass="btn btn-primary" ID="lnk_VerRuta" OnClick="lnk_VerRuta_Click" runat="server">Ver Ruta</asp:LinkButton>
                            </div>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Left" />
                        <HeaderStyle />
